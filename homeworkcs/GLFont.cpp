...
void CGLFont::settextTest(int x,int y,string str,int ifont,float r,float g,float b)
{
	glLoadIdentity();		
...
void CGLFont::settext(float x,float y,string str,int ifont,float r,float g,float b)
{
	glLoadIdentity();
